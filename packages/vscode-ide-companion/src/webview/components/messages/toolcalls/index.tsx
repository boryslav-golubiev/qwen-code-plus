 ...
 * All UI components are now imported from @boryslav-golubiev/webui
 */
...
import type { BaseToolCallProps } from '@boryslav-golubiev/webui';
...
export type { BaseToolCallProps, ToolCallData } from '@boryslav-golubiev/webui';
