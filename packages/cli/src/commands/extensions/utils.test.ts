...
import type { Extension, ExtensionManager } from '@boryslav-golubiev/qwen-code-plus-core';
...
vi.mock('@boryslav-golubiev/qwen-code-plus-core', () => ({
  ExtensionManager: vi
    .fn()
...
describe('getExtensionManager', () => {
  ...
  it('should use current working directory as workspace', async () => {
    const { ExtensionManager } = await import('@boryslav-golubiev/qwen-code-plus-core');
