...
describe('handleAutoUpdate', () => {
  ...
  beforeEach(() => {
    ...
    mockUpdateInfo = {
      update: {
        ...
        current: '1.0.0',
        type: 'major',
        name: '@boryslav-golubiev/qwen-code-plus',
      },
  ...
  it('should show manual update message when enableAutoUpdate is false', () => {
    ...
    mockGetInstallationInfo.mockReturnValue({
      updateCommand: 'npm i -g @boryslav-golubiev/qwen-code-plus@latest',
      updateMessage:
        'Please run npm i -g @boryslav-golubiev/qwen-code-plus@latest to update',
      isGlobal: true,
  ...
  it('should emit "update-failed" when the update process fails', async () => {
    ...
    expect(mockUpdateEventEmitter.emit).toHaveBeenCalledWith('update-failed', {
      message:
        'Automatic update failed. Please try updating manually. (command: npm i -g @boryslav-golubiev/qwen-code-plus@2.0.0, stderr: An error occurred)',
    });
  });
  ...
  it('should use the "@nightly" tag for nightly updates', async () => {
    ...
    expect(mockSpawn).toHaveBeenCalledWith(
      ...
      expect.arrayContaining([
        ...
        'npm i -g @boryslav-golubiev/qwen-code-plus@nightly',
      ]),
      {
        stdio: 'pipe',
      },
