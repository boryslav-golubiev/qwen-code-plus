...
import { isGitRepository } from '@boryslav-golubiev/qwen-code-plus-core';
...
describe('getInstallationInfo', () => {
  ...
  it('should detect global pnpm installation', () => {
    const pnpmPath = `/Users/test/.pnpm/global/5/node_modules/.pnpm/some-hash/node_modules/@boryslav-golubiev/qwen-code-plus/dist/index.js`;
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('pnpm add -g @boryslav-golubiev/qwen-code-plus@latest');
  ...
  it('should detect global yarn installation', () => {
    const yarnPath = `/Users/test/.yarn/global/node_modules/@boryslav-golubiev/qwen-code-plus/dist/index.js`;
    ...
    expect(info.updateCommand).toBe(
      'yarn global add @boryslav-golubiev/qwen-code-plus@latest',
    );
    expect(info.updateMessage).toContain('Attempting to automatically update');
  ...
  it('should detect global bun installation', () => {
    ...
    expect(info.isGlobal).toBe(true);
    expect(info.updateCommand).toBe('bun add -g @boryslav-golubiev/qwen-code-plus@latest');
    expect(info.updateMessage).toContain('Attempting to automatically update');
