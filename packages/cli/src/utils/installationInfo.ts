...
import { createDebugLogger, isGitRepository } from '@boryslav-golubiev/qwen-code-plus-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @boryslav-golubiev/qwen-code-plus@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @boryslav-golubiev/qwen-code-plus@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @boryslav-golubiev/qwen-code-plus@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @boryslav-golubiev/qwen-code-plus@latest';
    return {
