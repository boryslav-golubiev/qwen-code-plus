...
import { ExitPlanModeTool, ToolNames } from '@boryslav-golubiev/qwen-code-plus-core';
import type { ChatRecord, Config, Kind } from '@boryslav-golubiev/qwen-code-plus-core';
