...
import type { Extension, Config } from '@boryslav-golubiev/qwen-code-plus-core';
import { SettingScope, createDebugLogger } from '@boryslav-golubiev/qwen-code-plus-core';
