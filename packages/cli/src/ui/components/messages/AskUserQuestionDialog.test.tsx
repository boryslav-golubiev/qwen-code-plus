...
import type { ToolAskUserQuestionConfirmationDetails } from '@boryslav-golubiev/qwen-code-plus-core';
import { ToolConfirmationOutcome } from '@boryslav-golubiev/qwen-code-plus-core';
